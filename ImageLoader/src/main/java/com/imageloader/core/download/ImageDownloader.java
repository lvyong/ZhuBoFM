...
public abstract class ImageDownloader {
	...
	/** Retrieves {@link java.io.InputStream} of image by URI. Image can be located as in the network and on local file system. */
	...
	/**
	 * Retrieves {@link java.io.InputStream} of image by URI from other source. Should be overriden by successors to implement
